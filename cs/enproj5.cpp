...
void ProcessSavings(User &user) {
  ...
  while (contTransaction) {
    ...
    case 2:
      ...
      break;
    case 3:
      cout << "Current Balance: $" << user.getSaving().getBal() << endl;
      break;
    case 4:
    ...
    case 0:
      ...
      break;
    default:
      cout << "INVALID! ERROR! Please select something valid!" << endl;
    }
  }
}

void DoTrans(User &user) {
  int accountChoice;
...
void ReadData(User users[]) {
  ...
  double user_id, pin, checkingNumber, checkingBalance, savings_number,
      savings_balance;
  for (int i = 0;
       i < 10 && inFile >> user_id >> pin >> checkingNumber >>
                     checkingBalance >> savings_number >> savings_balance;
       ++i) {
